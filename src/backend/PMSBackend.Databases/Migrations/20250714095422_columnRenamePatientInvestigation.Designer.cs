...
namespace PMSBackend.Databases.Migrations
{
    ...
    [Migration("20250714095422_columnRenamePatientInvestigation")]
    partial class columnRenamePatientInvestigation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_ChamberEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("GoogleLocationLink")
                        .IsRequired()
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("OtherDoctorsId")
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("OverseasCaller")
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("Configuration_Chamber");
                });
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_DoctorChamberEntity", b =>
                {
                    ...
                    b.Property<string>("ChamberRemarks")
                        .IsRequired()
                        .HasColumnType("nvarchar(1500)");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_DoctorEducationDegreeEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Configuration_DoctorEducation");
                });
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_EducationEntity", b =>
                {
                    ...
                    b.Property<long?>("Configuration_DoctorEntityId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Configuration_DoctorEntityId");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_HospitalBranchEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Configuration_HospitalBranch");
                });
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_MedicineEntity", b =>
                {
                    ...
                    b.Property<string>("CompanyDiscount")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_VitalEntity", b =>
                {
                    ...
                    b.Property<long?>("Configuration_UnitEntityId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Configuration_UnitEntityId");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientDoctorEntity", b =>
                {
                    ...
                    b.Property<string>("ChamberFee")
                        .IsRequired()
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("ChamberWaitTime")
                        .IsRequired()
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientInvestigationEntity", b =>
                {
                    ...
                    b.Property<bool>("IsDoctorRecommendedTestCenter")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_DiagnosisCenterWiseTestEntity", b =>
                {
                    ...
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_HospitalBranchEntity", "DiagnosticTestCenterBranch")
                        .WithMany()
                        .HasForeignKey("TestCenterBranchId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("DiagnosticTestCenterBranch");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_DoctorChamberEntity", b =>
                {
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_ChamberEntity", "Chamber")
                        .WithMany()
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_DoctorEducationDegreeEntity", b =>
                {
                    ...
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_EducationEntity", "Education")
                        .WithMany()
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_EducationEntity", b =>
                {
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_DoctorEntity", null)
                        .WithMany("EducationAndDegrees")
                        .HasForeignKey("Configuration_DoctorEntityId");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_VitalEntity", b =>
                {
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_UnitEntity", null)
                        .WithMany("Unit")
                        .HasForeignKey("Configuration_UnitEntityId");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientInvestigationEntity", b =>
                {
                    ...
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_HospitalBranchEntity", "InvestigationTestCenterBranch")
                        .WithMany()
                        .HasForeignKey("TestCenterBranchId");

                    b.HasOne("PMSBackend.Domain.Entities.Configuration_HospitalEntity", "InvestigationTestCenter")
                        .WithMany()
                        .HasForeignKey("TestCenterId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("InvestigationTestCenter");

                    b.Navigation("InvestigationTestCenterBranch");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_DoctorEntity", b =>
                {
                    b.Navigation("EducationAndDegrees");
                });
